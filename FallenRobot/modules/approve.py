...
Maybe not enough to make them admin, but you might be ok with locks, blacklists, and antiflood not applying to them. 「 sᴜᴋᴜɴ ☯︎ ʀᴏʙᴏᴛ 」

That's what approvals are for - approve of trustworthy users to allow them to send 

*Admin commands from 「 sᴜᴋᴜɴ ☯︎ ʀᴏʙᴏᴛ 」:*
